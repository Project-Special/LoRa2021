...
public:
    ...
    // O tx_main/rx_main da 3.6.4 chama o rádio com a convenção do LR1121. Estes
    // dois overloads traduzem para a assinatura nativa do LR2021 (que veio da
    // 4.x), então o core do ELRS compila sem nenhuma alteração.
    //
    // Não há ambiguidade: o Config nativo exige 12 argumentos e este exige 10.
    void Config(uint8_t bw, uint8_t sf, uint8_t cr, uint32_t freq,
    ...
    {
        TXnb(data, false, nullptr, radioNumber);
    }
