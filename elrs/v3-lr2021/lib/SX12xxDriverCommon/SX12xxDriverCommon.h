...
// -----------------------------------------------------------------------------
// Retroportado do ExpressLRS 4.x. O LR2021Driver descreve a taxa como
// (modulação, banda) num byte só, e este namespace é a única coisa dele que
// não existe na 3.6.4. É todo constexpr, não gera código.
// -----------------------------------------------------------------------------
...
public:
    ...
    // Retroportados do 4.x: o LR2021Driver referencia os dois no caminho de
    // segundo rádio (diversidade). Aqui só existe um rádio, mas precisam existir
    // pra ele compilar sem alteração.
